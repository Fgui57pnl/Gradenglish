...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn-new'])) {
    ...
    $sql_count = "SELECT * FROM `khoa_hoc` order by `id_KH` desc limit 1 ";
    ...
    $sql="INSERT INTO `tai_lieu`(`Ten_Tai_Lieu`, `Ma_Khoa_Hoc`, `Loai_Tai_lieu`, `Link_Tai_Lieu`) 
                        VALUES ('$doc_name','$ma_khoa_hoc','$course_type','$course_link')";
    // Execute the query
